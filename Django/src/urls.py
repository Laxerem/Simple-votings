...
from django_site.views import register, results, vote, edit_profile, home, user_login, main, profile, user_logout, delete_user, create_survey, add_choices, survey_editor
...
urlpatterns = [
    ...
    path('vote/<int:survey_id>/', vote, name="start_voting"),
